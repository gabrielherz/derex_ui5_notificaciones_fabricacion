		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Prueba Odata autogenerated",
									"targetURL": "#projectpruebaodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectpruebaodata-display": {
								"semanticObject": "projectpruebaodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectpruebaodata",
									"url": sap.ui.require.toUrl("projectpruebaodata")
								}
							}
						}
					}
